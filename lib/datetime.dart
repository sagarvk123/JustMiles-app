...
import 'package:justmiles_app/coupon.dart';
import 'package:justmiles_app/couponsAvailable.dart';
import 'package:justmiles_app/orderComplete.dart';
...
import 'package:justmiles_app/notification.dart';

class Booking extends StatefulWidget {
  const Booking({Key key, @required this.database, this.appointment, this.carname,this.carprice}) : super(key: key);
...
class _BookingState extends State<Booking> {
  ...
  CouponVerify() async{
    ...
    if(coupon=='FIRST' && count<3){
      ...
      discount = 20;
      return PlatformAlertDialog(title: 'Congratulations!', content: 'Coupon Applied on your order.',defaultActionText: 'Okay',).show(context);
    }
    else if(coupon=='FIRST'){
      textDis = '';
      discount = 0;
      return PlatformAlertDialog(title: 'Not Available!', content: 'Coupon only for first 3 orders.',defaultActionText: 'Okay',).show(context);
    }
    else if(coupon=='EXTRA10'){
      status=1;
      textDis = 'Coupon Applied';
      discount = 10;
      return PlatformAlertDialog(title: 'Congratulations!', content: 'Coupon Applied for 10% off.',defaultActionText: 'Okay',).show(context);
    }
    else if(coupon=='REGULAR' && count>10){
      status=1;
      textDis = 'Coupon Applied';
      discount = 20;
      return PlatformAlertDialog(title: 'Congratulations!', content: 'Coupon Applied for your order.',defaultActionText: 'Okay',).show(context);
    }
    else if(coupon=='REGULAR'){
      textDis = '';
      discount = 0;
      return PlatformAlertDialog(title: 'Not Available!', content: 'Coupon only for users with more than 10 orders.',defaultActionText: 'Okay',).show(context);
    }
    else{
      print(coupon);
      textDis = '';
      status=0;
      discount = 0;
      return PlatformAlertDialog(title: 'Error!', content: 'Coupon not valid!',defaultActionText: 'Okay',).show(context);
    }
  ...
  Future<void> _submit() async {
    if (_validateAndSaveForm()) {
      ...
      try {
          ...
          Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context) => OrderComplete(carname: widget.carname, carcost: widget.carprice,)
    ),
    (route) => false,);
           ...
           child: Form(
             ...
             child: Column(
               children: <Widget>[
                 Row(
                   children: [
                     Text(" Please fill your details:", style: TextStyle(fontSize: 17),),
                   ],
                 ),
                 SizedBox(height: 20,),
                 TextFormField(
                 ...
                 Padding(
                   ...
                   child: TextFormField(
                     ...
                     validator: MultiValidator([
                       RequiredValidator(errorText: "Required"),
                       MinLengthValidator(10, errorText: "10 digit number required")
                     ]),
             ...
             Padding(
               ...
               child: TextFormField(
                 ...
                 validator: MultiValidator([
                   RequiredValidator(errorText: "Required"),
                   MinLengthValidator(6, errorText: "6 digit number required")
                 ]),
             ...
             Padding(
               ...
               child: TextFormField(
                 ...
                 Row(
                   children: [
                     Text("Select Pick up & Drop off dates:", style: TextStyle(fontSize: 17),),
                   ],
                 ),
                 SizedBox(height: 20,),
                 Column(
                   ...
                   children: <Widget>[
                     Row(
                       ...
                       children: [
                         Column(
                           children: [
                             Text( _dateTime == null ? "Select" : dateFormat.format(pickdate).toString().substring(0,11)),
                             RaisedButton(
                         ...
                         Column(
                           children: [
                             Text( dropdate == null ? "Select" : dateFormat.format(dropdate).toString().substring(0,11)),
                             RaisedButton(
                     ...
                     RaisedButton(
                       ...
                       child: Container(
                         ...
                         child: Padding(
                           ...
                           child: Text(" Confirm Your Booking ",style: TextStyle(fontSize: 17),),
                         ),
                       )
                     ),
                   ],
